...
//-----------------------------------------------------------------------------
TCaloChannelMap::TCaloChannelMap() {
  _data.resize(kMaxNChannels);
}

//-----------------------------------------------------------------------------
int TCaloChannelMap::Init(int RunNumber) {
...
//-----------------------------------------------------------------------------
TCaloChannelMap* TCaloChannelMap::Instance() {
  TCaloChannelMap* instance(nullptr);

  if  (instance == nullptr) {
    instance = new TCaloChannelMap();
  }
  return instance;
}
