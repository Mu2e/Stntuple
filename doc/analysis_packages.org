...
* internal structure of an STNTUPLE analysis package                         
 ...
 - *$pkg/ana/scripts* directory should contain a script named *load_stnana_scripts_$pkg.C*, 
   ...
   in [[file:../ana/scripts/load_stnana_scripts_Stntuple.C][Stntuple/ana/scripts/load_stnana_scripts_Stntuple.C]].
...
#+end_src
 - the _Debug_ parameter is intended to be used for troubleshooting 
