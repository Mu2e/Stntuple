...
* updates
** <2026-09-09 Wed> updates:                                                 
- TCalHitDataBlock/TCalHitData go away replaced by TCalHitBlock/TCalHit
- TCalDigi , TCalRecoDigi added
- TCrvDigi added, TCrvRecoPulse, TCrvCoincidenceCluster reworked
- THistBook added - start moving histogramming from TStnModule
- Stntuple/ana/TCrvTimeAnaModule.cc - example of running on the data
- Stntuple/test/make_crv.fcl - job configuration for running on the data
* ------------------------------------------------------------------------------
